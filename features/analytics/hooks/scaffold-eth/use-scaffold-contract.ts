...
import { useDeployedContractInfo } from '@/features/analytics/hooks/scaffold-eth/use-deployed-contract-info';
import { useTargetNetwork } from '@/features/analytics/hooks/scaffold-eth/use-target-network';
import {
  Contract,
  ContractName,
} from '@/features/analytics/utils/scaffold-eth/contract';
